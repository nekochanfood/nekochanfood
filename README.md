...
![Tech Stack](https://skillicons.dev/icons?i=docker,redis,postgres,linux,pnpm,nextjs,raspberrypi,tailwind,nodejs,nginx,git)

![Tech Stack](https://skillicons.dev/icons?i=illustrator,photoshop,ae,blender,unity,notion,vscode,neovim)
